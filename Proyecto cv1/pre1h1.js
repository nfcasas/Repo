if (screen.width > 600) {
    ...
    document.getElementById('preinicio').style.display='block'
    ...
    document.getElementById('pre3').style.display='block'
        ...
        document.getElementById('tituloacerca').style.display='none'
    ...
    function myFunction4() {
        ...
        document.getElementById('tituloacerca').style.display='block'    
        document.getElementById('link1').style.display='none'
        document.getElementById('link2').style.display='block'
        document.getElementById('link3').style.display='block'
        document.getElementById('link4').style.display='block'
